...
| Repository | [Mr-Shine09/desktop-mascot](https://github.com/Mr-Shine09/desktop-mascot) — **still private.** Public-release documentation, licensing, and CI landed 2026-08-08; visibility has not been changed. Blocking: the `/Users/oaksoekhant` scrub across 11 tracked files, and a first real CI run |
...
- Owner decisions taken this session:
  ...
  - **The macOS-username scrub is deferred to its own change.** `/Users/oaksoekhant` appears in 11 tracked files — the ten `art/animation/frames/*/normalization.json` provenance records plus this ledger. It leaks a real name, not a secret, and rewriting generated art metadata deserves a reviewable diff of its own. **This is open work and should be done before the repository goes public.**
