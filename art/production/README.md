...
1. Production direction: `../references/owner-selected-fallback-chibi.png`
2. Rejected tall reference evidence: `../references/owner-approved-tall-face.png`
...
## Rejected approved-face native iterations
...
- `mascot-base-approved-tall-40pt-at2x-80px-v3.png` and its QA sheet: explicitly rejected by the owner as visually unacceptable.

The entire approved-face native iteration set is historical evidence only and must never be consumed by the app or animation atlas.
