...
- Launch at login, signing, notarization, packaging, and clean-account install remain open. Reduce Motion is honored by the portal summon transition only; broader Reduce Motion coverage is still open under issue #11.
