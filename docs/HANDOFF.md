...
- The menu bar carries Summon/Dismiss, Pause, Manual Ideating, Roaming, Reposition, **Sleep Schedule** (adjustable hours, or off entirely), **Preview State** (forces any animation without an agent), **Agent Hook Setup** (copies the install snippet), diagnostics with VoiceOver labels, and Quit.
